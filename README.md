...
### Download:
Click on [here](https://github.com/shorbagy14/learnitbro-mozz-testing-tool/releases/download/1.2.1/learnitbro-mozz-testing-tool-1.2.1.jar) to download the latest build (version 1.2.1)
...
### New Features:
- Performance improvement for loading, saving and switching between nodes
- Added skip feature
